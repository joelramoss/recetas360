...
class _DetalleRecetaState extends State<DetalleReceta> {
  ...
  Map<String, bool> _ingredientesFaltantes = {}; // Mapa para rastrear ingredientes faltantes

  @override
  void initState() {
    super.initState();
    _comentariosRef = FirebaseFirestore.instance.collection('comentarios');
    _cargarIngredientesFaltantes(); // Cargar estado inicial de Firestore
  }

  // Cargar los ingredientes faltantes del usuario desde Firestore
  Future<void> _cargarIngredientesFaltantes() async {
    ...
    if (userId != null) {
      ...
      if (doc.exists) {
        ...
        // Si no existe, inicializamos todos como faltantes por defecto
        setState(() {
  ...
  // Guardar el estado de los ingredientes en Firestore
  ...
  // Marcar todos o ningún ingrediente como faltante
  ...
  // Mostrar los ingredientes faltantes en un diálogo al presionar el carrito
