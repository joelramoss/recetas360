                ...
                : StreamBuilder<QuerySnapshot>(
                    stream: FirebaseFirestore.instance
                        ...
                        .where(FieldPath.documentId,
                            whereIn: _favorites.keys.isNotEmpty
                    ...
                    builder: (context, snapshot) {
                      ...
                      if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                        return Center(
                          // Mensaje si no hay favoritos o error
                          child: Column(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                      ...
                      for (final receta in favoritas) {
                        final categoria = receta.categoria.isNotEmpty
                            ? receta.categoria
                            : 'Sin Categoría';
                        recetasPorCategoria
                            .putIfAbsent(categoria, () => [])
                            .add(receta);
                      }
                      // --- END GROUPING ---
                      ...
                      final categoriasOrdenadas =
                          recetasPorCategoria.keys.toList()..sort();

                      // --- BUILD LIST VIEW BY CATEGORY ---
                      return ListView.builder(
                        padding:
                            const EdgeInsets.all(16), // Padding around the list
                        itemCount:
                            categoriasOrdenadas.length, // Number of categories
                        itemBuilder: (context, index) {
                          final categoria = categoriasOrdenadas[index];
                          final recetasEnCategoria =
                          ...
                          return Card(
                            ...
                            child: ExpansionTile(
                              ...
                              leading: CircleAvatar(
                                ...
                                child:
                                    Icon(_getCategoryIcon(categoria), size: 20),
                              ),
                              title: Text(
                              ...
                              childrenPadding: const EdgeInsets.only(
                                  bottom: 8,
                                  left: 16,
                                  right: 16), // Padding for items inside
                              children: recetasEnCategoria.map((receta) {
                                // Map recipes in this category
                                final recetaId = receta.id;
                                final bool isFavorite = _favorites[recetaId] ??
                                    false; // Check favorite status
                                ...
                                return InkWell(
                                  ...
                                  child: Padding(
                                    padding: const EdgeInsets.symmetric(
                                        vertical:
                                            10.0), // Vertical padding for each item
                                    child: Row(
                              ...
                              delay: (index * 100).ms); // Animate card entrance
                        },
                      );
                      // --- END LIST VIEW ---
                    },
